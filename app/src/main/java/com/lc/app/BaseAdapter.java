...
/**
 * Created by Orange on 8/31/16.
 * BaseAdapter
 */
public abstract class BaseAdapter<D, V> extends
    ...
    /**
     * Whether or Not the RecyclerView is Scrolling Now
     */
     ...
     */
    @Nullable
    protected abstract RecyclerView.ViewHolder newHolder(@NonNull LayoutInflater inflater,
    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        data = isScrolling ? (data == null ? null : dataClone(data)) : data;
        bindViewHolder(holder, data, mView);
    }

    protected abstract void bindViewHolder(@NonNull RecyclerView.ViewHolder holder,
                                           @Nullable D data,
                                           @Nullable V view);

    /**
     * The Data Copy when scrolling
     *
     * @param data the origin data
     * @return the clone data
     */
    protected D dataClone(D data) {
        return data;
    }
    ...
    /**
     * Called From JAVA Reference.
     *
     * @param newState scrolling or not
     */
